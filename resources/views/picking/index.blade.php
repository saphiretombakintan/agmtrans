  ...
  <div class="col-md-4">
    <form class="form form-horizontal form-penjualan" method="post" action="transaksi/simpan">
      ...
      <div class="form-group">
        ...
        <div class="col-md-8">
          <input type="text" class="form-control" name="total" value="{{ $sumqtyctn }}"readonly>
        </div>
      </div>

      <div class="form-group">
        <label for="member" class="col-md-4 control-label">Kode Picker</label>
        <div class="col-md-8">
          <div class="input-group">
      ...
      <div class="form-group">
        <label for="kembali" class="col-md-4 control-label">Tanggal</label>
        <div class="col-md-8">
